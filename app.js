...
const DEFAULT_DATA = {
    ...
    fixedExpenses: [
        { name: 'PG Rent', amount: 7000, type: 'Need', category: 'Life Infrastructure' },
        { name: 'Monthly Food', amount: 3000, type: 'Need', category: 'Life Infrastructure' },
        { name: 'Miscellaneous', amount: 1500, type: 'Want', category: 'Lifestyle Enjoyment' },
        { name: 'Personal Loan EMI', amount: 9964, type: 'Need', category: 'Life Infrastructure' },
        { name: 'Home Loan EMI', amount: 10000, type: 'Need', category: 'Life Infrastructure' },
    ],
    bike: { emi: 3839, fuel: 1791, insurance: 240, maintenance: 958 },
    expenses: [],
    emis: [
        { id: 'emi1', name: 'Personal Loan', amount: 9964, totalLoan: 200000, rate: 14, tenure: 24, paid: 6, startDate: '2025-12-01', category: 'Personal Loan' },
        { id: 'emi2', name: 'Home Loan', amount: 10000, totalLoan: 500000, rate: 8.5, tenure: 60, paid: 3, startDate: '2026-03-01', category: 'Home Loan' },
    ],
};
...
function renderDashboard() {
    ...
    document.getElementById('emiBar').style.width = Math.min(100, (totalEmi / sal * 100)) + '%';
    ...
    document.getElementById('needsBar').style.width = Math.min(100, (needsSpent / needs * 100)) + '%';
    document.getElementById('wantsBar').style.width = Math.min(100, (wantsSpent / wants * 100)) + '%';
    document.getElementById('savingsBar').style.width = Math.min(100, (savingsSpent / savings * 100)) + '%';
...
document.getElementById('saveBudgetBtn').addEventListener('click', () => {
    DATA.salary = parseFloat(document.getElementById('setupSalary').value) || 37600;
...
function renderBikeTab() {
    ...
    bikeChartInst = new Chart(ctx, {
        type: 'doughnut',
        data: {
            labels: ['Buying Cost (₹1.12L)', 'Running Cost (₹1.72L)', 'Insurance (₹23K)', 'Maintenance (₹92K)', 'Gear (₹2.7K)'],
            datasets: [{ data: [112003, 171920, 23000, 92000, 2700], backgroundColor: ['#f59e0b','#ef4444','#8b5cf6','#06b6d4','#22c55e'], borderWidth: 0 }]
        },
